"""
Django settings for wdqms project.
...
SECRET_KEY = '$_ivuqxqf#3*ftt5k=rf*++)&uoo_d85urmrt3!%y!=&i)bb!y'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["128.65.196.37","127.0.0.1"]
...
CELERY_BEAT_SCHEDULE ={
    'task-number-one': {
        'task': 'wdqms.tasks.task_number_one',
